...
<?php 
	...
	$consultap = "SELECT grafico FROM neumatico WHERE id = '" .$id. "'";
...
<body>
	<div class="container">
		...
		<div class="resultados">
			<object><iframe src=" <?php header('Content-type: application/pdf'); ?> <?php echo $filap['grafico']; ?>" width="100" height="100" style="border: 1px;"></iframe></object>
		</div>
	</div>
</body>
</html>
