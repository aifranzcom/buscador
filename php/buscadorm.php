<?php 
	...
	$consultap = "SELECT id, plano, descripcion FROM planos WHERE plano LIKE '%" .$search. "%' OR descripcion LIKE '%" .$search. "%' ";
 ...
 <?php if ($total>0 && $search!='') { ?>
 			...
 			<?php do { ?>
 				<div class="detalles">
 					<a href="php/detallem.php?id=<?php echo $fila['id'] ?>&search=<?php echo $search ?> ">
...
<br>
 <?php if ($totalp>0 && $search!='') { ?>
 			...
 			<?php do { ?>
 				<div class="detalles">
 					<a href="php/detallem.php?id=<?php echo $filap['id'] ?>&search=<?php echo $search ?> ">
